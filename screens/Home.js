...
export default class HomeScreen extends Component {
  constructor() {
    ...
    this.state = {
      articleDetails: {},
      ngrok_url: "https://4613-27-4-170-116.ngrok.io",
    };
  }
  ...
  getArticle = () => {
    const url = this.state.ngrok_url + "/get_Article";
    axios
      .get(url)
      .then((response) => {
  ...
  likedArticle = () => {
    const url = this.state.ngrok_url + "/liked_article";
    axios
      .get(url)
      .then((response) => {
        this.getArticle();
  ...
  unlikedArticle = () => {
    const url = this.state.ngrok_url + "/not_like_articles";
    axios
      .get(url)
      .then((response) => {
        this.getArticle();
